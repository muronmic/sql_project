...
-- že nìkteré státy se jmenují jinak v rùzných tabulkách, proto je chci napasovat
...
-- Nìkteré státy mìly u provedených testù více údajù pro jeden den, chceme se tìchto "duplicit" zbavit
...
-- Náboženství - otázka - mám tam dávat všechna náboženství nebo staèí jenom ta nejèastìjší? 
...
-- poèasí 
-- použití NULLIF - zmìní 0 na NULL a count ignoruje NULL 
...
-- poèasí k mìstu pøiøazuji stát, používám tabulku cities - je to dobøe? 
