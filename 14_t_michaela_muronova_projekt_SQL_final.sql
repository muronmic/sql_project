...
-- pro pøípad, že by údaj s iso3 v tabulce nebyl, pøidávám možnost spojit tabulky i pomocí názvu country.
-- Zaokrouhluji údaje o hustotì obyvatel a rozdílu dožití na dvì desetinná místa.
