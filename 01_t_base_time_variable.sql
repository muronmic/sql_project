...
-- Funkci CASE WHEN používám i pro zobrazení roèního období (jaro - 0, léto - 1 atd.)
-- CASE WHEN je použito i pro populaci a to kvùli tomu, že v každé tabulce se státy jmenují jinak a tímto zpùsobem napasujeme všechny.
-- Sloupec iso3 používám, abychom mìli sloupec, který se narozdíl od jmen státù v tabulkách neliší, tento sloupec budeme
-- pozdìji používat pro spojování tabulek.
